...
import com.adriano.cursomc.domain.ItemPedido;
...
import com.adriano.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p4 = new Produto(null,"Mesa Escriório",300.00);
		...
		Estado est2 = new Estado(null,"Säo Paulo");
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "acrossi.eprom@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null,"Ana Costa", "acr_ac@hotmail.com", "94759528024", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli1.getTelefones().addAll(Arrays.asList("29393323","938389272"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2107", null, "Centro", "059484373", cli2, c2);
